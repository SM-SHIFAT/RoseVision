...
class RoseLeafDeseaseDetectionApp extends StatefulWidget {
  const RoseLeafDeseaseDetectionApp({Key? key}) : super(key: key);

  @override
  _RoseLeafDeseaseDetectionAppState createState() =>
      _RoseLeafDeseaseDetectionAppState();
}

class _RoseLeafDeseaseDetectionAppState
...
//tensorflow lite plugin loads models and labels.
    await Tflite.loadModel(
        model: 'assets/rose_model.tflite', labels: 'assets/leaf_labels.txt');
  }
                ...
                if (_image != null)
                  Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                          bottom: -15,
                          child: galleryOrCamera(Icons.arrow_forward, null, 65,
                              null, _disSubmit, 2)),
                    ],
                  ),
                const SizedBox(
                    ...
                    child: Row(
                        ...
                        children: [
                          galleryOrCamera(Icons.camera, ImageSource.camera, 50,
                              null, false, 1),
                          galleryOrCamera(Icons.photo_album,
                              ImageSource.gallery, 50, null, false, 1),
                          galleryOrCamera(
...
//contains 55% of the screen height.
  ...
  ElevatedButton galleryOrCamera(IconData icon, ImageSource? imageSource,
